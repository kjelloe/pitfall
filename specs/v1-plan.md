...
| Art | Neon-retro low poly: flat-shaded meshes, bright ANSI-like palette on dark shaft, fog-to-black below, CSS scanline overlay. Death VFX (2026-08-01, user request): a player dying bursts into ~40 tumbling confetti pieces (their color + neon palette + white, unlit InstancedMesh, gravity + spin + drag, shrink-out over ~1.5 s) instead of vanishing |
